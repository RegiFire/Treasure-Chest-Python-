...
class Player(object):
    ...
    def move(self, diceval):
        ...
        self.moveCount += 1
        print(self.name + ":score: " + str(self.num) + "/Laddernumber: " + str(self.numLadder) + "/Snakenumber: " + str(self.numSnake) + " /movecount: " + str(self.moveCount))
        self.nametext = font.render(str(self.name), True, (0, 0, 255), (0, 255, 0))
