...
class Dice(object):
    ...
    dice1 = pygame.image.load(r'dice_1.png')
    dice2 = pygame.image.load(r'dice_2.png')
    dice3 = pygame.image.load(r'dice_3.png')
    dice4 = pygame.image.load(r'dice_4.png')
    dice5 = pygame.image.load(r'dice_5.png')
    dice6 = pygame.image.load(r'dice_6.png')
